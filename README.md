...
The css styles are the minified latest version of UIKit 3 ( currently 3.1.9 ) from the cdn.
...
The `uikit.min.js` file is the minified latest version of UIKit 3 ( currently 3.1.9 ) from the cdn. 
