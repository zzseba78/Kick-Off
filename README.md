...
The css styles are the minified latest version of UIKit 3 ( currently 3.0.0-beta.40 ) from the cdn, you can find it here.
HTML
...
The `uikit.min.js` file is the minified latest version of UIKit 3 ( currently 3.0.0-beta.40 ) from the cdn, you can find it here.
